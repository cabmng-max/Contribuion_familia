...
<label class="wide"><span data-i18n="spouses">Conjoint(s)</span><select id="spouse-select" name="conjoint_ids" multiple onchange="spouseSelectionChanged(this)">${all}</select><span class="hint" data-i18n="spouseHint">Plusieurs personnes existantes peuvent être choisies.</span><button class="secondary" type="button" onclick="addNewSpouse()" data-i18n="addSpouse">＋ Ajouter un nouveau conjoint</button></label>
